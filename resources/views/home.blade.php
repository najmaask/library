...
@section('content')
            <div class="row">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Lew Shawon</td>
                                                        <td><span>Suara Dari Milea</span></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>Lew Shawon</td>
                                                        <td><span>Bad Girl In Pesantren</span></td>
                                                        <td><span>456 pcs</span></td>
                                                        <td><span class="badge badge-warning">Pending</span></td>
                                                    </tr>
                                                </tbody>
                                    ...
                                    <div class="recent-comment">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h4 class="media-heading">Restu Hadi</h4>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h4 class="media-heading">Adnan Maulana</h4>
                                                <p>Cras sit amet nibh libero, in gravida nulla. </p>
                                                <div class="comment-action">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="footer">
                                    <p>2018 © Admin Board. - <a href="#">najmaweb.com</a></p>
                                </div>
                            </div>
                        </div>
                    </section>
